      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-4xl space-y-6">
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow-md p-6"
          >
            <h2 className="text-2xl font-bold mb-6">🎨 Cores do Tema</h2>
            <p className="text-sm text-gray-600 mb-6">
              Configure as cores principais que serão aplicadas em toda a landing page.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) => setSettings({
                      ...settings,
                      theme_colors: { ...settings.theme_colors, text: e.target.value }
                    })}
                    className="w-10 h-10 rounded border cursor-pointer"
                  />
                  <input
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    value={settings.theme_colors.button}
                    onChange={(e) => setSettings({
                      ...settings,
                      theme_colors: { ...settings.theme_colors, button: e.target.value }
                    })}
                    className="w-10 h-10 rounded border cursor-pointer"
                  />
                  <input
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="color"
                    value={settings.theme_colors.buttonText}
                    onChange={(e) => setSettings({
                      ...settings,
                      theme_colors: { ...settings.theme_colors, buttonText: e.target.value }
                    })}
                    className="w-10 h-10 rounded border cursor-pointer"
                  />
                  <input
